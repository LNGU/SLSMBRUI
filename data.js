...
const defaultRawData = {
    publishers: [
        ...
        { id: 2, name: 'Anthropic', title: 'Claude Code', type: 'SaaS', contact: 'Kathren', renewalDate: '', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 3, name: 'Articulate Global LLC', title: '• Articulate 360 • Reach 360 Pro', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-06-30', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 4, name: 'Autodesk Inc.', title: '3ds Max Maya MotionBuilder – Mudbox Flame ShotGrid', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-10-26', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 5, name: 'Catchpoint Systems Inc.', title: 'Catchpoint', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-06-30', status: 'In Review', savingsAmount: 0, savingsType: null },
        ...
        { id: 10, name: 'Open AI', title: 'ChatGPT Enterprise', type: 'SaaS', contact: 'Kathren', renewalDate: '', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 11, name: 'Perforce Software, Inc.', title: '• Helix Core • Helix Digital Asset Management', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-06-29', status: 'In Review', savingsAmount: 0, savingsType: null },
        ...
        { id: 13, name: 'SensorTower Inc.', title: 'SensorTower Data.AI', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-06-30', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 14, name: 'ServiceNow', title: 'UU Platform', type: 'SaaS', contact: 'Kathren / Anahit', renewalDate: '2026-06-29', status: 'In Review', savingsAmount: 3723770.88, savingsType: 'Cost Reduction' },
        ...
        { id: 17, name: 'TechSmith', title: 'Camtasia & Snagit', type: 'On Prem', contact: 'Neva', renewalDate: '', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 18, name: 'Trimble', title: 'Sketchup', type: 'On Prem', contact: 'Neva', renewalDate: '', status: 'In Review', savingsAmount: 0, savingsType: null },
        { id: 19, name: 'UserTesting Technologies, Inc.', title: 'UserTesting', type: 'SaaS', contact: 'Kathren', renewalDate: '2026-08-31', status: 'In Review', savingsAmount: 0, savingsType: null },
    ...
    spendData: [
        { publisher: 'Adobe', companySpend: 13644684.7, msdSpend: 111765.18, tiamSpend: 26000, fiscalYear: 'FY26', notes: '' },
        ...
        { publisher: 'ServiceNow', companySpend: 87113707.92, msdSpend: 4954050, tiamSpend: 0, fiscalYear: 'FY26', notes: '' },
        { publisher: 'Staffbase Canada Systems, Inc.', companySpend: 733803.84, msdSpend: 733803.84, tiamSpend: 733803.84, fiscalYear: 'FY26', notes: '' },
    ...
    riskData: [
        ...
        { publisher: 'Tactivos Inc.', sspa: 'Supplier status is restricted. Supplier Code of Conduct is non-compliant.\nSSPA Supplier DPR due date = 12/4/2025', po: '', finance: '', legal: '', inventory: '', details: '' },
    ...
    managedTitles: [
        ...
        { title: 'JetBrains All Products Pack', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains CLion', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains DataGrip', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains dotTracer', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains dotUltimate', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains GoLand', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains IntelliJ IDEA Ultimate', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains PhpStorm', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains PyCharm', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains ReShaper', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains Rider', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains RubyMine', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains TeamCity', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        { title: 'JetBrains WebStorm', publisher: 'JetBrains America Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        ...
        { title: 'ChatGPT Enterprise', publisher: 'Open AI', category: 'Other', licenseCount: 0, notes: 'active' },
        ...
        { title: 'Telerik  DevCraft Complete Enterprise', publisher: 'Progress', category: 'Other', licenseCount: 0, notes: 'active' },
        ...
        { title: 'Staffbase', publisher: 'Staffbase Canada Systems, Inc.', category: 'Other', licenseCount: 0, notes: 'active' },
        ...
        { title: 'LINQPad', publisher: 'LINQPad Pty Ltd', category: 'Other', licenseCount: 0, notes: 'active' },
    ],
    datasetVersion: 'FY26_NEFAYPGRAFF_2026-02-24',
    externalKpis: [
        { name: 'SNOW Tickets MTD', value: 450, unit: 'tickets', source: 'ServiceNow', lastUpdated: '2026-02-24', notes: '' },
        { name: 'ICM Tickets MTD', value: 450, unit: 'tickets', source: 'ICM System', lastUpdated: '2026-02-24', notes: '' },
    ]
};
